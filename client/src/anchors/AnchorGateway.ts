 ...
 * AnchorGateway handles HTTP requests to the host, which is located on the server.
 * This AnchorGateway object uses the baseEndpoint, and additional server information
